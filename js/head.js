const head = `
    ...
    <!--*Style Sheet-->
    <link rel="stylesheet" href="styles/AKstyles2.css">
    ...
    <style> @import url('https://fonts.googleapis.com/css2?family=Krona+One&family=Righteous&family=Turret+Road:wght@800&family=Unbounded:wght@500&display=swap'); </style>
`;
//Head Snippet
var headInsert = document.getElementById("head");
headInsert.innerHTML = head;
